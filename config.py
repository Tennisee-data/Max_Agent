...
class Config:
    def __init__(self, config_file='config.yaml'):
        ...
        self.cleaned_text_directory = config.get('cleaned_text_directory', "./cleaned_texts/")
        self.font_directory = config.get('font_directory', "./dejavu-sans/")
        self.processed_files_log = config.get('processed_files_log', "./processed_pdfs.txt")
        self.log_file = config.get('log_file', "pdf_summariser.log")
        self.summarization_model_id = config.get('summarization_model_id', "facebook/bart-large-cnn")
